...
#-----------------------------------------------------------------------------|
# TEST_2:                                                                     |
# Time Complexity of GeomFPOP  for small dimensions (p = 2, 3, 4)             |
# for the data without changes                                                |
#-----------------------------------------------------------------------------|
...
# 'TC_Res_p_1_GeomFPOP_type_all_all*_it_100_.txt',                        |
# with p = 2, 3, 4  and type = R or S,  Time limit:TimeLimit = 200 s      |
#-------------------------------------------------------------------------|
